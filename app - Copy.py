...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///C:/Users/chory/Desktop/Flask Projects/database_populator/recipeDatabase.db'
...
def addRecipe():
    ...
    ifCommit = True
    #get a random recipe
    random = requests.get('https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/random?limitLicense=true&number=3',
    headers={
    ...
    for i in range(0,2):
        ...
        if(ifCommit):
            ...
            totalsimilarRecipes = SimilarRecipe.query.count()

    return '<h1> Total Recipes: ' + str(totalrecipes) + ' Total Similar Recipes: ' + str(totalsimilarRecipes) + '</h1>'
